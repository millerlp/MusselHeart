...
#define USE_SDIO 1 // 0 for SPI Sd Card, 1 for Teensy Sd Card
//------------------------------------------------------------------------------
// Pin definitions.
//
// SD chip select pin.
//const uint8_t SD_CS_PIN = SS;  // not needed when using SDIO on Teensy3.5?
//
...
SdFatSdio sd; // altered from SdFat
...
//  if (!sd.begin()) { // Use simple .begin() when using SDIO on Teensy3.5
